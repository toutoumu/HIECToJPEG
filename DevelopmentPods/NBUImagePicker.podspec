...
Pod::Spec.new do |s|
    ...
    s.subspec 'Camera' do |sub|
        sub.source_files    = 'NBUImagePicker/Camera/*.{h,m}'
    ...
    s.subspec 'Image' do |sub|
        sub.source_files    = 'NBUImagePicker/Image/*.{h,m}'
        sub.dependency      'NBUImagePicker/MediaInfo'
    end
    
    s.subspec 'Gallery' do |sub|
        sub.source_files    = 'NBUImagePicker/Gallery/*.{h,m}'
        sub.dependency      'NBUImagePicker/Assets'
        sub.dependency      'NBUImagePicker/MediaInfo'
    end
    
    s.subspec 'MediaInfo' do |sub|
        sub.source_files    = 'NBUImagePicker/MediaInfo/*.{h,m}'
        sub.dependency      'NBUImagePicker/Assets'
    end
    
    s.subspec 'Picker' do |sub|
        sub.source_files    = 'NBUImagePicker/Picker/*.{h,m}'
    ...
    s.subspec 'Resources' do |sub|
        sub.resource_bundle = { 'NBUImagePicker' => ['NBUImagePicker/Resources/*.{png,lproj}', 'NBUImagePicker/Resources/filters', 'NBUImagePicker/**/*.{storyboard,xib}'] }
    end
