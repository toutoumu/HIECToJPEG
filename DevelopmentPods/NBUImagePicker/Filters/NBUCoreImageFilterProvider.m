                  ...
                  toImage:(UIImage *)image
{
    ...
    for (NBUFilter * filter in filters)
    {
        ...
        {
            ciImage = [self applyCIFilter:filter.concreteFilter toCIImage:ciImage];
        }
        else
        {
            // Auto adjust off?
            ...
            {
                ciImage = [self applyCIFilter:ciFilter toCIImage:ciImage];
            }
        }
    }
...
+ (CIImage *)applyCIFilter:(CIFilter *)ciFilter toCIImage:(CIImage *)ciImage
{
