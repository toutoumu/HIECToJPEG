...
- (instancetype)initWithCoder:(NSCoder *)aDecoder{
    ...
    if(self){
        ...
        [array addObject:[NSNumber numberWithInt:30]];//震动时长
        [_vibeDictionary setObject:array forKey:@"VibePattern"];
        [_vibeDictionary setObject:[NSNumber numberWithFloat:1.0] forKey:@"Intensity"];// 震动强度
    }
    return self;
}
...
- (void)viewDidLoad {
    ...
    //为拍摄按钮添加触摸手势 , 第一次点击设置好相机参数,然后移除掉手势, 让其调用 tackePicture
